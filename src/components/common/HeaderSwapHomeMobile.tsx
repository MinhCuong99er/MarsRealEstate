...
interface HeaderSwapHomeMobileProps {
  title?: any
  globalStore?: GlobalHydration
  authStore?: AuthHydration
}

const HeaderSwapHomeMobile: FC<HeaderSwapHomeMobileProps> = (props: HeaderSwapHomeMobileProps) => {
  const { /* title,  */ globalStore /* authStore */ } = props
  ...
  return (
    <>
      <div className="m-header-moblieswap">
        <span className="m-header-moblieswap__title">
          {/* {title} */}
          <img
            className="m-header-moblieswap__back"
            onClick={() => router.push('/')}
            // src="/images/mpoint-logo.png"
            src="/images/logo-megaone.png"
            /* height={130}
            width={90} */
          />
        </span>
