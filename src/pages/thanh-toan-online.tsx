...
const PageViewHandler = dynamic(() => import('@src/components/PaymentOnline'), {
  ssr: false,
  loading: () => <PageLoading />,
})
...
const PaymentOnline: React.FC<PaymentOnlineProps> = () => {
  useEffect(() => {
...
export default withLayout(PaymentOnline)
