...
const PageViewHandler = dynamic(() => import('@src/components/GivePoint'), {
  ssr: false,
  loading: () => <PageLoading />,
})

interface GivePointProps {
  token: string
}

const GivePoint: React.FC<GivePointProps> = () => {
  useEffect(() => {
...
export default withLayout(GivePoint)
